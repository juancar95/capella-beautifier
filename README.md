...
1. Download **`capella-beautifier-v1.0.0-full.zip`** from [Releases](https://github.com/juancar95/capella-beautifier/releases)
2. Unzip the package
3. Copy `capella-beautify-1.0.0.jar` to your Capella **dropins** folder:
