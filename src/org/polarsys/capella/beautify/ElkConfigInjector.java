/*
 * Copyright (c) 2024-2026 HASIC Project Contributors.
...
public class ElkConfigInjector extends SessionManagerListener.Stub {
    ...
    public static CustomLayoutConfiguration createFullElkConfig() {
        ...
        // Spacing (tight)
        addDoubleOption(c, "org.eclipse.elk.spacing.nodeNode", 10.0, LayoutOptionTarget.PARENT);
        addDoubleOption(c, "org.eclipse.elk.layered.spacing.nodeNodeBetweenLayers", 15.0, LayoutOptionTarget.PARENT);
        ...
        // Container padding (reduce empty space inside containers)
        addDoubleOption(c, "org.eclipse.elk.padding.top", 5.0, LayoutOptionTarget.PARENT);
        addDoubleOption(c, "org.eclipse.elk.padding.bottom", 5.0, LayoutOptionTarget.PARENT);
        addDoubleOption(c, "org.eclipse.elk.padding.left", 5.0, LayoutOptionTarget.PARENT);
        addDoubleOption(c, "org.eclipse.elk.padding.right", 5.0, LayoutOptionTarget.PARENT);
